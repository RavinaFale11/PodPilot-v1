...
const PlayIcon = styled.div`
  ...
  display: flex;
  align-items: center;
  background: linear-gradient(135deg, #9000ff, #ff00ff) !important;
  ...
  box-shadow: 0 0 16px 4px rgba(144, 0, 255, 0.3) !important;
`;
...
const Card = styled(Link)`
  ...
  &:hover {
    cursor: pointer;
    transform: perspective(1000px) rotateX(2deg) rotateY(1deg) translateY(-8px) scale(1.03);
...
const Favorite = styled(IconButton)`
  ...
  position: absolute !important;
  backdrop-filter: blur(4px);
  box-shadow: 0 0 16px 6px rgba(34, 36, 35, 0.5) !important;
`;
